...
1. In your WordPress admin screen, click **Plugins** -> **Add New Plugin** -> **Upload Plugin** -> **Choose file** <br/><br/>
...
2. Choose **onesignal-main.zip** and click **Open** <br/><br/>
...
5. You're done, and should see **UnoSignal** in your admin menu <br/><br/>
...
5. Save the Settings page. You'll be directed to a new page with **Upload Files** and **Add Code to Site**, ignore this and click **Finish** at the bottom of the page. <br/><br/>
...
2. Save Changes
3. You should see a check below each field. That's it! <br/><br/>
...
- When you Publish the post, a notification will be sent. <br/><br/>
