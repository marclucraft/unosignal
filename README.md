...
- When you Publish the post, a notification will be sent. <br/>
...
- In the **OneSignal Push Notifications** metabox, you can choose a different URL for your Mobile app subscribers ([Deep Link](https://documentation.onesignal.com/docs/links#deep-linking)) – If you do not include a different URL, it will direct them to your Website (via a WebView in your app), rather than a specific page of your app. <br/>
